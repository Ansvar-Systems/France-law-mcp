...
If you are a lawyer (avocat), legal researcher, or other legal professional:

- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (faute professionnelle)
...
- **Professional Rules**: Members of the Conseil National des Barreaux (CNB) and local Ordres des Avocats must comply with applicable professional conduct rules (déontologie) when using AI tools
- **Client Disclosure**: Consider whether professional ethics rules (règles déontologiques) require disclosing AI tool use to clients
...
1. Checking the official source (Légifrance — legifrance.gouv.fr)
2. Verifying the provision is currently in force (en vigueur) and has not been amended (modifié) or repealed (abrogé)
3. Reading the full context of cited provisions
4. Consulting case law (jurisprudence) and preparatory works (travaux préparatoires) for interpretation
...
This Tool aggregates data from official French legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **Légifrance (legifrance.gouv.fr)** | Authoritative | Statute text, codes, regulations (primary reference) |
...
- Dalloz, LexisNexis France (JurisClasseur), Lexbase, Lamy

These services provide editorial oversight, comprehensive annotations (commentaires, notes d'arrêt), and professional-grade currency guarantees that this Tool **cannot** provide.
...
- French law changes continuously through new statutes (lois), decrees (décrets), ordinances (ordonnances), and court decisions (arrêts)
...
- Even "fresh" data may be outdated if recent amendments were published in the Journal officiel de la République française (JORF)
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (droit positif)

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended (modifié) after the last database update
  - Repealed (abrogé) but not yet removed from the database
  - Subject to transitional rules (dispositions transitoires) affecting its applicability
...
1. **Complete case law** -- Coverage of Cour de cassation, Conseil d'État, Conseil constitutionnel, and lower court decisions is limited; do not rely solely on this for case law research (recherche jurisprudentielle)
2. **Historical statute versions** -- Limited availability of historical provision wording (versions antérieures)
3. **Legal commentary** -- No editorial annotations, academic doctrine (doctrine), or practice guides
4. **Unpublished decisions** -- Lower court decisions (jugements) and administrative rulings largely absent
5. **Full legislative history** -- Limited coverage of parliamentary debates, rapports, and travaux préparatoires
...
- **Context Missing**: Without doctrine and travaux préparatoires, interpretation may be incorrect
...
- This includes but is not limited to:
  - Professional malpractice claims (responsabilité professionnelle)
  - Lost cases or adverse judgments
  - Client harm from erroneous advice
  - Regulatory sanctions from bar authorities (sanctions disciplinaires)
  - Reputational damage
...
- **Sensitive Matters**: For privileged legal matters (secret professionnel), consider on-premise deployment

### Competence and Diligence

Using this Tool does not reduce your professional obligations to:

- Exercise independent legal judgment (appréciation indépendante)
- Conduct thorough legal research using authoritative sources
- Stay current with legal developments
- Provide competent representation (diligence et compétence)

## Recommended Workflow for Professional Use

1. **Initial Research**: Use Tool for preliminary research and hypothesis generation
2. **Official Verification**: Cross-check ALL results with official sources (Légifrance — legifrance.gouv.fr)
3. **Commercial Databases**: Use professional legal databases (Dalloz, LexisNexis France, Lexbase) for authoritative, annotated versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/French-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/French-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (Légifrance)
...
- **COMPLY** with CNB / Ordre des Avocats professional ethics rules regarding AI tool use and client confidentiality
- **DISCLOSE** to clients if required by professional rules (déontologie)
